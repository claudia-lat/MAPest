...
subplot (6,3,4) % Right Ankle roty ----------------------------
% DS
for shadedIdx = 1 : patternRanges.nrOfDS
    y1 = maxVal;
    y2 = minVal;
...
subplot (6,3,7) % Right Ankle rotz ----------------------------
% DS
for shadedIdx = 1 : patternRanges.nrOfDS
    y1 = maxVal;
    y2 = minVal;
...
subplot (6,3,10) % Left Ankle rotx ----------------------------
% DS
for shadedIdx = 1 : patternRanges.nrOfDS
    y1 = maxVal;
    y2 = minVal;
...
subplot (6,3,13) % Left Ankle roty ----------------------------
% DS
for shadedIdx = 1 : patternRanges.nrOfDS
    y1 = maxVal;
    y2 = minVal;
