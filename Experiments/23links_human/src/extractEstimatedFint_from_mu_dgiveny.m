function Fint = extractEstimatedFint_from_mu_dgiveny(berdy, selectedJoints, mu_dgiveny)
...
for i = 1 : nrOfJoints
    range(i,1) = (rangeOfDynamicVariable(berdy, iDynTree.JOINT_WRENCH, selectedJoints{i}));
