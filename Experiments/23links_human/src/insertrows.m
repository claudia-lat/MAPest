...
%        C = ipermute(C,[3 1 2]) 
%
%     % to create the File Exchange image:
%        A = randi(3, 10, 3) ;
%        ix = randi(11,10,1) - 1 ;
%        B = insertrows(A, 4, ix) ;
...
% 3.0, may 2016 - updated to R2016a
% 3.1, jan 2019 - updated to R2018b
narginchk(2, 3) ;
if nargin == 2
...
C = [A ; B] ;
% 2. sort the respective indices, the first output of sort is ignored
[~, abi] = sort([(1:sa(1)).' ; ind(:)]) ;
