...
% % --------COM %uncomment if you want to use it
...
% --------JOINTS %uncomment if you want to use it
...
for i = 1 : suit.properties.nrOfSensors
    ...
    %     suit.sensors{i}.meas.sensorMagneticField    = zeros(3, suit.properties.lenData); %uncomment if you want to use it
end
