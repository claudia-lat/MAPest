...
%SUBJECTPARAMS 
% BOX SIZE VECTOR [DIM ALONG X]
%                  DIM ALONG Y
%                  DIM ALONG Z]
% VEDERE FIG 60. 


% x in cylindere is the diameter
...
% box origin
subjectParams.rightShoulderBoxOrigin = 0.5 * [0, -subjectParams.rightSho_y, 0];%wrt jRightC7Shoulder
% mass and inertia
...
% box origin
subjectParams.leftShoulderBoxOrigin = 0.5 * [0, subjectParams.leftSho_y, 0];%wrt jLeftC7Shoulder
% mass and inertia
