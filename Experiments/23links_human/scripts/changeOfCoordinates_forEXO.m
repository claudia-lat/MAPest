...
%     qx_rightC7Sho = synchroKin(blockIdx).q(jRshoC7Rotx_idx,:) * 180/pi; %deg
    ...
    tau_rightSho = [estimatedVariablesForEXO.tau(blockIdx).values(jRshoRotx_idx,:); ...
        estimatedVariablesForEXO.tau(blockIdx).values(jRshoRoty_idx,:); ...
        estimatedVariablesForEXO.tau(blockIdx).values(jRshoRotz_idx,:)];
...
%     qx_leftC7Sho = synchroKin(blockIdx).q(jLshoC7Rotx_idx,:) * 180/pi; %deg
    ...
    % Torques estimated by MAP with angles q
    tau_leftSho = [estimatedVariablesForEXO.tau(blockIdx).values(jLshoRotx_idx,:); ...
        estimatedVariablesForEXO.tau(blockIdx).values(jLshoRoty_idx,:); ...
        estimatedVariablesForEXO.tau(blockIdx).values(jLshoRotz_idx,:)];
